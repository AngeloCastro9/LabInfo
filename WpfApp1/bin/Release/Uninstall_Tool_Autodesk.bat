...
ping -n 1 -w 1000 10.54.!labNumber!.%%G > nul
	IF !errorlevel! EQU 0 (
		PsExec64.exe \\10.54.!labNumber!.%%G -u 7SETLABS\manutencaofa7 -p shift1dois3 -h -d -i "C:\Program Files (x86)\Common Files\Autodesk Shared\Uninstall Tool\R1/UninstallTool.exe"
	) ELSE (
